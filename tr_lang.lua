...
local function CreateScriptEditor()
    ...
    EditorTitle.Text = "Script Editörü"
    ...
    EditorBox.Text = "-- Kodunu buraya yaz\n-- 'editor:close' yazarak kapat"
    ...
    ExecuteButton.MouseButton1Click:Connect(function()
        ...
        if scriptText == "editor:close" then
            ...
            if not success then
                ...
                warn("Script başarıyla çalıştı!")
            end
        end
    end)
end

-- Ana GUI Yükleme Fonksiyonu
local function LoadMainGui()
    if gameId == MM2_PLACE_ID then
        ...
        CreateButton(ScrollFrame, "Herkesi Öldür", KillAll, yPos); yPos = yPos + 50
        ...
        JumpBox = CreateTextBox(ScrollFrame, "Zıplama Gücü (örn: 50)", yPos); yPos = yPos + 40
        CreateButton(ScrollFrame, "Zıplamayı Ayarla", SetJumpPower, yPos); yPos = yPos + 50
        CreateButton(ScrollFrame, "Görünmezlik", ToggleInvisible, yPos); yPos = yPos + 50
        CreateButton(ScrollFrame, "Coin Topla", AutoCollectCoins, yPos); yPos = yPos + 50
        CreateButton(ScrollFrame, "Şerifin Silahını Al", GrabSheriffGun, yPos); yPos = yPos + 50
        ...
        CreateButton(ScrollFrame, "Editör Aç", CreateScriptEditor, yPos); yPos = yPos + 50
    ...
    elseif gameId == ARSENAL_PLACE_ID then
        ...
        warn("PPHub - Arsenal Menüsü Yüklendi!")
    else
        local ScreenGui = Instance.new("ScreenGui")
        ...
        local Title = Instance.new("TextLabel")
        Title.Size = UDim2.new(1, 0, 0, 40)
        Title.Text = "PPHub - Script Çalıştırıcı"
        Title.TextColor3 = Color3.fromRGB(0, 255, 127)
        Title.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
        Title.BorderSizePixel = 0
        Title.Font = Enum.Font.GothamBold
        ...
        local yPos = 50
        CreateButton(MainFrame, "Editör Aç", CreateScriptEditor, yPos)

        warn("PPHub - Script Çalıştırıcı Yüklendi!")
    end
end

-- Script Başlangıcı (Oyuncu karakteri yüklenene kadar bekle)
